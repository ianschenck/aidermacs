    ...
    (if prompt-file
        (progn
          ...
          (unless (file-exists-p prompt-file)
            ...
            (insert "# For vterm backend multiline input:\n")
            (insert "#   Shift+Enter: Enter multiline mode/add new line\n")
            (insert "#   Ctrl+Enter: Send multiline content\n")
            (insert "#   C-c C-k: Cancel multiline input\n\n")
            (insert "* Sample task:\n\n")
